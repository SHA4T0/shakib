...
def do_zip_update():
    success = False
    if DEBUG_MODE:
        zip_url = "https://github.com/SHA4T0"
        dir_name = "SHA4T0"
    else:
        zip_url = "https://github.com/SHA4T0"
        dir_name = "SHA4T0"
    ...
    if success:
        ...
        mesgdcrt.WarningMessage(
            "Grab The Latest one From https://www.facebook.com/ITS.SHA4T0")
...
def do_git_update():
    ...
    if success:
        ...
        print(
            "git checkout . && "
            "git pull https://github.com/SHA4T0 HEAD")
    sys.exit()
...
parser.add_argument("-c", "--contributors", action="store_true",
                    help="show current SHA4T0 contributors")
parser.add_argument("-v", "--version", action="store_true",
                    help="show current SHA4T0 version")
